    ...
    <SafeAreaView style={styles.mainbody} >
      <View style={styles.imgtxtbody}>
        <View style={styles.imagebody}>
          <Image source={require("@/assets/images/o1.png")} style={styles.welcome} resizeMode="contain" />
        </View>
        <View style={styles.txtbody}>
          <Text style={styles.maintxt}>You don’t need to be extreme, just consistent. Let’s start today.</Text>
        </View>
      </View>
